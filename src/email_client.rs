...
pub struct EmailClient {
    ...
    base_url: String,
    http_client: Client,
    authorisation_token: SecretString,
}
...
mod email_client_tests {
    ...
    impl wiremock::Match for SendEmailBodyMatcher {
        fn matches(&self, request: &wiremock::Request) -> bool {
            ...
            if let Ok(body) = result {
                // Check that all mandatory field are populated
    ...
    async fn send_email_sends_the_expected_request() {
        ...
        Mock::given(header_exists("X-Postmark-Server-Token"))
            ...
            // Assert that this mock will receive exactly one request
            // We could use ranges to test other things, like at least one (1..)
            .expect(1)
            .mount(&mock_server)
            .await;
        ...
        // Assert
        // Assertions on a mockserver are verified when it goes out of scope.
    }
